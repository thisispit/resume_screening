...
SKILL_TAXONOMY: dict[str, list[str]] = {
    ...
    "hadoop": ["hadoop", "hdfs"],
    "hive": ["apache hive", "hiveql", "hive"],
    "airflow": ["airflow"],
    "dbt": ["dbt", "data build tool"],
    "snowflake": ["snowflake"],
    "bigquery": ["bigquery"],
    "databricks": ["databricks"],
    "power bi": ["power bi", "powerbi", "powerbi desktop"],
    ...
    "vector database": ["vector database", "pinecone", "faiss", "chromadb", "chroma", "weaviate", "milvus"],
    "fine-tuning": ["fine-tuning", "finetuning", "fine tuning"],
    "embeddings": ["embeddings", "sentence-transformers", "word2vec", "glove"],
    "tokenization": ["tokenization", "tokenizer", "tokenizers"],
    "transformers": ["transformers", "hugging face", "huggingface"],
    "linear regression": ["linear regression", "logistic regression"],
    "classification": ["classification", "svm", "decision tree", "random forest", "naive bayes"],
    "clustering": ["clustering", "k-means", "kmeans", "dbscan"],
    "time series": ["time series", "time-series", "prophet", "arima"],
    "recommender systems": ["recommender systems", "recommendation system", "collaborative filtering"],
    "model deployment": ["model deployment", "mlflow", "llamaindex", "api deployment", "model serving"],
    # DevOps / platform
    "ansible": ["ansible"],
    ...
    "ui/ux design": ["ui/ux", "ui ux", "ui design", "ux design", "wireframing", "prototyping"],
    # Soft / business (extra)
    ...
    "time management": ["time management", "multitasking", "multitask"],
    "critical thinking": ["critical thinking", "logical reasoning"],
    "adaptability": ["adaptability", "quick learner", "fast learner"],
